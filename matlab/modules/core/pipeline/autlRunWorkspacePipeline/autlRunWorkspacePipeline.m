...
collectionConfig.mavlink_master = localGetValue(cfg, 'mavlink_master', 'tcp:127.0.0.1:5760');
...
collectionConfig.control_backend = lower(char(string(localGetValue(cfg, 'control_backend', 'mavros'))));
